...
int main(int argv, char* argc[])
{
	...
	std::cout << "Path Deleting From:\t" << '\n';
	std::vector<element_t> extensions_to_remove_from_system {".c++", ".C++", ".cpp", ".CPP", ".hpp", "HPP",".cc", ".CC", ".exe", ".EXE", ".gpg", ".GPG", ".zip", ".ZIP", ".jpg", ".JPG", ".tiff", ".TIFF", ".jpeg", ".JPEG", ".mp4", ".MP4", ".png", ".PNG" /*add more extensions or remove to only delete the ones that matter to you, to delete.*/};
	
	for(auto& i : extensions_to_remove_from_system){
